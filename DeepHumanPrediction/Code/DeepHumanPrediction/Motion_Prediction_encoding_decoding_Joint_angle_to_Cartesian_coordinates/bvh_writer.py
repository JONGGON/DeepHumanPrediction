...
def Motion_Data_Making(seed_motion , pre_motion , seed_timestep , pre_timestep , batch_Frame ,  frame_Time , file_directory, test=False):
    ...
    motion_length=int(len(pre_motion[0])/pre_timestep)

    seed_motion=seed_motion.reshape(test_size , seed_timestep , motion_length)
    pre_motion=pre_motion.reshape(test_size , pre_timestep , motion_length)
