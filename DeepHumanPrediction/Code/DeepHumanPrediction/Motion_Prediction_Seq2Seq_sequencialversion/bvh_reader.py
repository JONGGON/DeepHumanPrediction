...
def Motion_Data_Preprocessing(time_step=100, seed_timestep=20, batch_Frame=5 ,TEST=False):
    ...
    train_label_motion = np.reshape(train_label_motion, (len(files), int((time_step-seed_timestep) / batch_Frame), len(Data[0][0]) * batch_Frame))
...
if __name__ == "__main__":
    ...
    Normalization_factor, train_motion, train_label_motion, seed_timestep, pre_timestep, column, file_directory = Motion_Data_Preprocessing(time_step=150, seed_timestep=30, batch_Frame=5 , TEST=False)
