...
if TEST:
    ...
    MotionNet(TEST=TEST , order=1 , save_period=1382 , num_layer=num_layer , cell=cell, hidden_unit=hidden_unit , time_step = time_step ,
    ...
    for i in range(75,len(train_file_directory)+1,1):
