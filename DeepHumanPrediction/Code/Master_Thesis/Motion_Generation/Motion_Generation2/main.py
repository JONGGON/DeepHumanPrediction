...
if TEST :
    ...
    MotionNet(TEST=TEST , save_period=60000, num_layer=num_layer , cell=cell, hidden_unit=hidden_unit , time_step = time_step ,
    ...
    #batch learning
    completed = MotionNet(epoch=100000 , batch_size=68 , save_period=save_period, cost_limit=0.01 ,
